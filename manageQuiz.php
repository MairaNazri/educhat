...
<body>
  ...
  <div class="main" id="main">
    ...
    <div class="content">
      ...
      <a class="add-button" href="addQuiz.php">➕ Add New Quiz</a>
        ...
        <tbody>
          <?php while ($quiz = $result->fetch_assoc()): ?>
            <tr>
              ...
              <td><?= htmlspecialchars($quiz['proficiency_level']) ?></td>
              <td>
                <a class="action-link" href="editQuiz.php?id=<?= $quiz['quizID'] ?>">Edit</a> |
                <a class="action-link" href="deleteQuiz.php?id=<?= $quiz['quizID'] ?>" onclick="return confirm('Are you sure?');">Delete</a> |
                <a class="action-link" href="manageQuestion.php?quizID=<?= $quiz['quizID'] ?>">Manage Questions</a>
              </td>
            </tr>
          <?php endwhile; ?>
        </tbody>
